						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/project1/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/toko/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/toko/cancel.php"/>
									<input type="hidden" name="currency_code" value="USD"/>
									<input type="hidden" name="custom" value="'.$_SESSION["uid"].'"/>
									<input style="float:right;margin-right:80px;" type="image" name="submit"
										src="https://www.google.com/url?sa=i&url=https%3A%2F%2Fwww.citypng.com%2Fphoto%2F18784%2Fhd-paypal-checkout-yellow-button-png&psig=AOvVaw0D92ADZ3EQguuUJmxrsfEM&ust=1750263160048000&source=images&cd=vfe&opi=89978449&ved=0CBQQjRxqFwoTCMiC4cDs-I0DFQAAAAAdAAAAABAp" alt="PayPal Checkout"
